<template>
	<view>
		<view @click="chooseImage" class="slot-btn">
			<slot></slot>
		</view>
		<view class="image-cropper" @wheel="cropper.mousewheel" v-if="showOper">
			<button class="btn button" size="mini" type="primary" @click="() => {showOper=false}">取消</button>
			...
			<view class="pic-preview" :change:init="cropper.initObserver" :init="initData"
